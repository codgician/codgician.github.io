...
我们不妨先给每个节点随意赋值一个顶标（我们可以赋值 $A_i = \max\limits_{i \leq j \leq N} \{ w(i, j) \}, B_j = 0$）。接着，我们采取适当的策略不断扩大相等子图的规模，直至相等子图中存在完备匹配。这样，依据上面的定理，我们便找到了最大权匹配。
...
- liam0205 - [二分图最大匹配问题与匈牙利算法的核心思想](https://liam0205.me/2016/04/03/icpc-notes/hungarian-algorithm-in-the-maximum-matching-problem-of-bigraph/)
